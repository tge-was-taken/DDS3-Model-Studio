...
namespace DDS3ModelLibrary.Textures.Processing
{
    ...
    {
        /// <summary>
        /// Create a new <see cref="System.Drawing.Bitmap"/> instance using a color palette, per-pixel palette color indices and the image width and height.
        /// </summary>
        ...
        /// <returns>A new <see cref="System.Drawing.Bitmap"/> instance created using the data provided.</returns>
        ...
        public static void QuantizeBitmap(Bitmap bitmap, int paletteColorCount, out byte[] indices, out Color[] palette)
        {
            ...
            WuQuantizer.WuQuantizer quantizer = new WuQuantizer.WuQuantizer();
